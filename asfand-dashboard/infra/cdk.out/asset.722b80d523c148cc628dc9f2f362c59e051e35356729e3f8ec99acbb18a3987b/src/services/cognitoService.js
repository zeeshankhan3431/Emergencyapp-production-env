...
/** Seed a user in the in-memory Cognito mock (local dev). */
export function seedMockCognitoUser(email, password, sub, verified = true) {
  mockStore.set(email.trim().toLowerCase(), { sub, password, verified });
}
